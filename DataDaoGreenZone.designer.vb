...
<System.Data.Linq.Mapping.DatabaseAttribute(Name:="greenzone")>  _
Partial Public Class DaoGreenZone
  ...
  End Sub
    Partial Private Sub Insertfacvecab(instance As DataDaoGreenZone.facvecab)
    End Sub
    Partial Private Sub Updatefacvecab(instance As DataDaoGreenZone.facvecab)
    End Sub
    Partial Private Sub Deletefacvecab(instance As DataDaoGreenZone.facvecab)
    End Sub
  #End Region
	
	Public Sub New()
		MyBase.New(Global.Alertas.My.MySettings.Default.greenzoneConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	Public ReadOnly Property facvecabs() As System.Data.Linq.Table(Of DataDaoGreenZone.facvecab)
		Get
			Return Me.GetTable(Of DataDaoGreenZone.facvecab)
		End Get
	End Property
End Class

Namespace DataDaoGreenZone
